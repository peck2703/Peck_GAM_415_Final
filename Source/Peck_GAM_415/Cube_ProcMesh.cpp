...
// Called every frame
void ACube_ProcMesh::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void ACube_ProcMesh::PostActorCreated()
{
...
void ACube_ProcMesh::CreateSquare()
{
...
void ACube_ProcMesh::GenerateBoxMesh()
{
...
void ACube_ProcMesh::CreateBoxMesh(FVector BoxRadius, TArray<FVector>& Vertices, TArray<int32>& Triangles, TArray<FVector>& Normals, TArray<FVector2D>& UVs, TArray<FProcMeshTangent>& Tangents, TArray<FColor>& Colors)
{
