...
// Called every frame
void ATrapezoid::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void ATrapezoid::PostActorCreated()
{
...
void ATrapezoid::GenerateBoxMesh()
{
...
void ATrapezoid::CreateBoxMesh(FVector BoxRadius, TArray<FVector>& Vertices, TArray<int32>& Triangles, TArray<FVector>& Normals, TArray<FVector2D>& UVs, TArray<FProcMeshTangent>& Tangents, TArray<FColor>& Colors)
{
