...
// Called every frame
void ACube_RunMesh::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void ACube_RunMesh::PostActorCreated()
{
...
void ACube_RunMesh::CreateSquare()
{
...
void ACube_RunMesh::GenerateBoxMesh()
{
...
void ACube_RunMesh::CreateBoxMesh(FVector BoxRadius, TArray<FVector>& Vertices, TArray<int32>& Triangles, TArray<FVector>& Normals, TArray<FVector2D>& UVs, TArray<FRuntimeMeshTangent>& Tangents, TArray<FColor>& Colors)
{
